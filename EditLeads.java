...
public class EditLeads {
	...
	driver.manage().window().maximize();
	 ...
	 driver.findElement(By.id("username")).sendKeys("demosalesmanager");
		...
		driver.findElement(By.xpath( "(//input[@name='firstName'])[3]")).sendKeys("aswin");
	   ...
	   Thread.sleep(5000);
		   ...
		   driver.findElement(By.xpath("//input[@class='inputBox'][1]")).sendKeys("newcompanyname");
		   driver.findElement(By.xpath( "//input[@class='smallSubmit'][1]")).click();
		   String text2 = driver.findElement(By.xpath( "//span[@id='viewLead_companyName_sp']")).getText();
		   System.out.println(text2);
		   if(text2.contains("newcompanyname (10207)")) {
